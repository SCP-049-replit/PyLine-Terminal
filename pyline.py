...
def help():
    print('''\nFull documentation available in the README included with the terminal
...
def name():
    name = input("\033[0;30mEnter new name: \033[0;0m")
...
def create():
    name = input("\033[0;30mEnter file name: \033[0;0m")
...
def delete():
    file = input("\033[0;30mEnter file name: \033[0;0m")
    try:
        import os
...
def folcreate():
    import os
    name = input("\033[0;30mEnter directory name: \033[0;0m")
...
def foladd():
    file = input("\033[0;30mEnter file name: \033[0;0m")
    folder = input("\033[0;30mEnter directory name: \033[0;0m")
